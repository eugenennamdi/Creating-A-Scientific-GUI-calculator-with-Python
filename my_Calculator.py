'''Creating a simple Python Calculator with GUI Tkinter'''
...
def iCalc(source, side):
    storeObj = Frame(source, borderwidth=4, bd=4, bg="gray25")
...
#adding a display widget

        display = StringVar()
        Entry(self, relief=RIDGE, textvariable=display,
              justify='right'
              , bd=30, bg="gray25").pack(side=TOP,
        ...
        for iEquals in "=":
            if iEquals == '=':
                ...
                btniEquals = button(EqualButton, LEFT, iEquals,
                                    ...
                                    (storeObj.get() + s))
#adding an event trigger to enable user to perform calc. functions
